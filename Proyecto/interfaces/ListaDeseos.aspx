         ...
         <div>
            ...
            protected void Page_Load(object sender, EventArgs e)
            {
                ...
                try
                {
                    ...
                    var sql1 = from camp in lndeseos.publicacionesdeseo(Convert.ToInt32(Session["usuario"].ToString()))
                    ...
                    var sql = from camp in lndeseos.publicacionesdeseo(Convert.ToInt32(Session["usuario"].ToString()))
                              select new { codigoPublicacio = camp.codigo_Pub };
