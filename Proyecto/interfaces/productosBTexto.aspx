<%@ Page Title="" Language="C#" MasterPageFile="~/interfaces/Principal.Master" AutoEventWireup="true" CodeBehind="productosBTexto.aspx.cs" Inherits="Proyecto.interfaces.productosBTexto" %>
            ...
            <script runat="server" Language="C#">
                ...
                public void busquedaPorNombre()
                {
                    ...
                    try
                    {
                        ...
                        var sql1 = from camp in lnPublicacion.buquedaPublicaciones(Session["BuscarPorNombre"].ToString())
                        ...
                        var sql = from camp in lnPublicacion.buquedaPublicaciones(Session["BuscarPorNombre"].ToString())
                ...
                { Session["codigoCategoria"] = 1; Response.Redirect("/interfaces/productosBCategoria.aspx"); }
                public void Button2_Click(object sender, EventArgs e)
                { Session["codigoCategoria"] = 2; Response.Redirect("/interfaces/productosBCategoria.aspx"); }
                public void Button3_Click(object sender, EventArgs e)
                { Session["codigoCategoria"] = 3; Response.Redirect("/interfaces/productosBCategoria.aspx"); }
                public void Button4_Click(object sender, EventArgs e)
                { Session["codigoCategoria"] = 4; Response.Redirect("/interfaces/productosBCategoria.aspx"); }
                public void Button5_Click(object sender, EventArgs e)
                { Session["codigoCategoria"] = 5; Response.Redirect("/interfaces/productosBCategoria.aspx"); }
                public void Button6_Click(object sender, EventArgs e)
                { Session["codigoCategoria"] = 6; Response.Redirect("/interfaces/productosBCategoria.aspx"); }
                public void Button7_Click(object sender, EventArgs e)
                { Session["codigoCategoria"] = 7; Response.Redirect("/interfaces/productosBCategoria.aspx"); }
                public void Button8_Click(object sender, EventArgs e)
                { Session["BuscarPorNombre"] = TextBox1.Text; Response.Redirect("/interfaces/productosBTexto.aspx"); }
